line_num <- commandArgs(trailingOnly = T)[1]


pop_nhaps <- read.table("/home/ishigohoka/projects/Miriam/PhD/PhD/inv_freq_abc/list/pop_nhaps.txt", col.names=c("pop", "nhaps"))

params <- read.table("/home/ishigohoka/projects/Miriam/PhD/PhD/inv_freq_abc/output/demography/abc/model_2_1_2_posterior.txt", header=T)
params$N_N0_4 <- 1
...
cat_config(params[line_num,], pop_nhaps$nhaps, nsites)
