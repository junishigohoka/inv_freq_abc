...
END{
        ...
        printf " -ej %f %d %d", T_medlong/(4*N_anc), 2, 3
        printf " -ej %f %d %d", T_res/(4*N_anc), 4, 3
        printf " -ej %f %d %d", T_can_mad/(4*N_anc), 6, 5
        printf " -ej %f %d %d", T_azo_cap/(4*N_anc), 8, 7
        printf " -ej %f %d %d", T_mac2/(4*N_anc), 7, 5
        printf " -ej %f %d %d", T_mac1/(4*N_anc), 5, 3
        printf " -ej %f %d %d", T_mal/(4*N_anc), 9, 3
        printf " -ej %f %d %d", T_cre/(4*N_anc), 10, 3
        printf " -ej %f %d %d", T_geo/(4*N_anc), 3, 1
        printf "\n"
}
