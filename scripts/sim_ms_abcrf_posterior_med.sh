...
$command | awk -v simid=1 -f scripts/ms2stats.awk - list/pop_nhaps.txt > output/demography/post_ms_slim/${model}_abcrf_posterior_med_ms_out.txt
echo $random >> output/demography/post_ms_slim/${model}_abcrf_posterior_med_ms_seed.txt
